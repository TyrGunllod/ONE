...
#recebendo novos registros e o gestor gostaria de possuir a informação atualizada
#da quantidade de filiais em cada Estado.

#A partir da coluna com a informação dos Estados,
#crie um dicionário usando dict comprehension com a chave sendo o nome de um Estado
#e o valor sendo a contagem de vezes em que o Estado aparece na lista.
